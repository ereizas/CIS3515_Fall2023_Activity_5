...
class NumberDisplayAdapter (private val numbers: Array<Int>,private val changeTextSize : (Int) -> Unit) : RecyclerView.Adapter<NumberDisplayAdapter.NumberViewHolder>() {
    ...
    inner class NumberViewHolder (layout: View) : RecyclerView.ViewHolder (layout) {
        ...
        init
        {
            textView.setOnClickListener{changeTextSize(numbers[adapterPosition])}
        }
